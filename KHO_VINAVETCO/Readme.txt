SELECT TENNCC,MANCC,CONGNO, CONGNO-(CONGNO1-CONGNO2) AS CHENHLECH FROM(
SELECT TENNCC,MANCC,CONGNO,
(SELECT CASE WHEN SUM(TIENPHAITRA-TIENDATRA) IS NULL THEN 0 ELSE SUM(TIENPHAITRA-TIENDATRA) END  FROM HOADONNHAP WHERE MANCC= NHACUNGCAP.MANCC) AS CONGNO1,
(SELECT CASE WHEN SUM(TIENPHAITRA-TIENDATRA) IS NULL THEN 0 ELSE SUM(TIENPHAITRA-TIENDATRA) END  FROM TRAHOADONNHAP WHERE MANCC= NHACUNGCAP.MANCC) AS CONGNO2
...
(SELECT CASE WHEN SUM(TIENPHAITRA-TIENDATRA) IS NULL THEN 0 ELSE SUM(TIENPHAITRA-TIENDATRA) END  FROM HOADONXUAT WHERE MAKH= KHACHHANG.MAKH) AS CONGNO1,
(SELECT CASE WHEN SUM(TIENPHAITRA-TIENDATRA) IS NULL THEN 0 ELSE SUM(TIENPHAITRA-TIENDATRA) END  FROM TRAHOADONXUAT WHERE MAKH= KHACHHANG.MAKH) AS CONGNO2
