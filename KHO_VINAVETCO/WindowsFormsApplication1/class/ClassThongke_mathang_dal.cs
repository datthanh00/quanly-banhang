...
namespace WindowsFormsApplication1
{
    class ClassThongke_mathang_dal :Provider
    {
        ...
        public DataTable gettonkhotonghop(Class_DTO_ThongKe dto)
        {
            ...
            String SQL = "select mathang.MAMH, TENMH,KLDVT, DONVITINH, TENKHO, TENNCC, SOLUONGMH,SOLUONGMH*KLDVT AS KHOILUONG, GIAMUA, giamua*soluongmh as THANHTIEN   from mathang, donvitinh, kho, NHACUNGCAP where mathang.madvt=donvitinh.madvt and  mathang.makho=kho.makho and mathang.MANCC=NHACUNGCAP.MANCC " + SQL1 + " and mathang.makho='" + PublicVariable.MAKHO + "'";
            return getdata(SQL);
