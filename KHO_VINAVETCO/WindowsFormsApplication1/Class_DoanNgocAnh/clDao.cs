...
namespace WindowsFormsApplication1
{
    ...
    class clDao:Provider
    {
        ...
        public DataTable getTonKhoTTngay2(clDTO dto)
        {
            ...
            String SQL = TYPE + "SELECT TENMH+' - ' +CONVERT(VARCHAR,KLDVT)+' - '+DONVITINH AS TENMH,MATHANG.MAMH,T1.GIAMUA,LOHANG, MATHANG.MANCC, TENNCC,KLDVT, DONVITINH,convert(varchar,GETDATE(),103) AS NGAY, TONCUOI AS TONTT, TONCUOI-TONCUOI AS CHENHLECH, TONDAU, TONDAU*KLDVT AS KLTONDAU, TONDAU*T1.GIAMUA AS THANHTIENTONDAU, NHAP, NHAP*KLDVT AS KLNHAP, THANHTIENNHAP, XUAT, XUAT*KLDVT AS KLXUAT, THANHTIENXUAT, TRANHAP, TRANHAP*KLDVT AS KLTRANHAP, THANHTIENTRANHAP, TRAXUAT, TRAXUAT*KLDVT AS KLTRAXUAT, THANHTIENTRAXUAT, TONCUOI, TONCUOI*KLDVT AS KLTONCUOI, TONCUOI*T1.GIAMUA AS THANHTIENTONCUOI FROM"
