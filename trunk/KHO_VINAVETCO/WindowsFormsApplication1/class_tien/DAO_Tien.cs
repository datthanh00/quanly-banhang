...
namespace WindowsFormsApplication1
{
    ...
    class CONGNOKH:Provider
    {
       // public  Mysqlchange MSQL = new Mysqlchange();
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT 'PT' AS TYPE,KHACHHANG.MAKH,TENKH,MAPT,SOTIEN,NGAYTHU AS NGAY FROM PHIEUTHU, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUTHU.MADOITUONG AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL SELECT 'PC' AS TYPE, KHACHHANG.MAKH,TENKH,MAPC AS MAPT,-SOTIEN AS SOTIEN,NGAYCHI AS NGAY FROM PHIEUCHI, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUCHI.MADOITUONG  AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'";
            return pv.getdata(SQL);
        }
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT KHACHHANG.MAKH,TENKH,MAPT AS MAHD,SOTIEN,NGAYTHU AS NGAY,N'Khách Trả Tiền' AS CHUCNANG FROM PHIEUTHU, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUTHU.MADOITUONG AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL SELECT KHACHHANG.MAKH,TENKH,MAPC  AS MAHD,SOTIEN AS SOTIEN,NGAYCHI AS NGAY,N'Khách Nhận Tiền' AS CHUCNANG FROM PHIEUCHI, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUCHI.MADOITUONG  AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                +" UNION ALL SELECT KHACHHANG.MAKH,TENKH,MAHDX  AS MAHD,TIENPHAITRA AS SOTIEN,NGAYXUAT AS NGAY,N'Mua Hàng' AS CHUCNANG FROM HOADONXUAT, KHACHHANG WHERE KHACHHANG.MAKH=HOADONXUAT.MAKH  AND NGAYXUAT BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                +" UNION ALL SELECT KHACHHANG.MAKH,TENKH,MAHDX  AS MAHD,TIENPHAITRA AS SOTIEN,NGAYXUAT AS NGAY,N'Trả Hàng' AS CHUCNANG FROM TRAHOADONXUAT, KHACHHANG WHERE KHACHHANG.MAKH=TRAHOADONXUAT.MAKH  AND NGAYXUAT BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'";
            return pv.getdata(SQL);
        }
    ...
    class CONGNONCC
    {
       // public  Mysqlchange MSQL = new Mysqlchange();
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT 'PC' AS TYPE,NHACUNGCAP.MANCC,TENNCC,MAPC,SOTIEN,NGAYCHI AS NGAY FROM PHIEUCHI, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUCHI.MADOITUONG AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL  SELECT 'PT' AS TYPE,NHACUNGCAP.MANCC,TENNCC,MAPT AS MAPC,-SOTIEN AS SOTIEN,NGAYTHU AS NGAY FROM PHIEUTHU, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUTHU.MADOITUONG  AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'";
            return pv.getdata(SQL);
        }
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT NHACUNGCAP.MANCC,TENNCC,MAPT AS MAHD,SOTIEN,NGAYTHU AS NGAY,N'Nhận Tiền NCC' AS CHUCNANG FROM PHIEUTHU, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUTHU.MADOITUONG AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL SELECT NHACUNGCAP.MANCC,TENNCC,MAPC  AS MAHD,SOTIEN AS SOTIEN,NGAYCHI AS NGAY,N'Trả Tiền NCC' AS CHUCNANG FROM PHIEUCHI, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUCHI.MADOITUONG  AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL SELECT NHACUNGCAP.MANCC,TENNCC,MAHDN  AS MAHD,TIENPHAITRA AS SOTIEN,NGAYNHAP AS NGAY,N'Mua Hàng' AS CHUCNANG FROM HOADONNHAP, NHACUNGCAP WHERE NHACUNGCAP.MANCC=HOADONNHAP.MANCC  AND NGAYNHAP BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'"
                + " UNION ALL SELECT NHACUNGCAP.MANCC,TENNCC,MAHDN  AS MAHD,TIENPHAITRA AS SOTIEN,NGAYNHAP AS NGAY,N'Trả Hàng' AS CHUCNANG FROM TRAHOADONNHAP, NHACUNGCAP WHERE NHACUNGCAP.MANCC=TRAHOADONNHAP.MANCC  AND NGAYNHAP BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'";
            return pv.getdata(SQL);
        }
