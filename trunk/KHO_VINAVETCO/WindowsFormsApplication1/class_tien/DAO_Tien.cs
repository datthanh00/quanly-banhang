...
namespace WindowsFormsApplication1
{
    ...
    class CONGNOKH:Provider
    {
       // public  Mysqlchange MSQL = new Mysqlchange();
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT 'PT' AS TYPE,KHACHHANG.MAKH,TENKH,MAPT,SOTIEN,NGAYTHU AS NGAY,IDNHAP FROM PHIEUTHU, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUTHU.MADOITUONG AND SOTIEN <> 0 AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "' AND KHACHHANG.MAKHO='" + PublicVariable.MAKHO + "'"
                + " UNION ALL SELECT 'PC' AS TYPE, KHACHHANG.MAKH,TENKH,MAPC AS MAPT,-SOTIEN AS SOTIEN,NGAYCHI AS NGAY,IDNHAP FROM PHIEUCHI, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUCHI.MADOITUONG  AND SOTIEN <> 0 AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "' AND KHACHHANG.MAKHO='" + PublicVariable.MAKHO + "'";
            return pv.getdata(SQL);
        }
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT KHACHHANG.MAKH,TENKH,MAPT AS MAHD,-SOTIEN AS SOTIEN,NGAYTHU AS NGAY,N'Khách Trả Tiền' AS CHUCNANG,IDNHAP FROM PHIEUTHU, KHACHHANG WHERE KHACHHANG.MAKH=PHIEUTHU.MADOITUONG AND SOTIEN <> 0 AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "' AND KHACHHANG.MAKHO='" + PublicVariable.MAKHO + "'"
    ...
    class CONGNONCC
    {
       // public  Mysqlchange MSQL = new Mysqlchange();
        ...
        {
            Provider pv = new Provider();
            string SQL = "SELECT NHACUNGCAP.MANCC,TENNCC,MAPT AS MAHD,SOTIEN ,NGAYTHU AS NGAY,N'Nhận Tiền NCC' AS CHUCNANG,IDNHAP FROM PHIEUTHU, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUTHU.MADOITUONG AND SOTIEN <> 0 AND NGAYTHU BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "'  AND NHACUNGCAP.MAKHO='" + PublicVariable.MAKHO + "'"
                + " UNION ALL SELECT NHACUNGCAP.MANCC,TENNCC,MAPC  AS MAHD,-SOTIEN AS SOTIEN,NGAYCHI AS NGAY,N'Trả Tiền NCC' AS CHUCNANG,IDNHAP FROM PHIEUCHI, NHACUNGCAP WHERE NHACUNGCAP.MANCC=PHIEUCHI.MADOITUONG  AND SOTIEN <> 0 AND NGAYCHI BETWEEN '" + NGAYBD + "' and '" + NGAYKT + "' AND NHACUNGCAP.MAKHO='" + PublicVariable.MAKHO + "'"
